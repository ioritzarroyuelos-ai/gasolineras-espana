...
// Ceuta y Melilla) e info de partidos. Única fuente de verdad, compartida por el
// robot (Node) y el Worker (src/*.ts la importa vía .d.mts). Metadatos
// verificados en vivo el 2026-09-23.
//
...
//   null si aún no existe (europeas 2029, y anticipadas recientes: Aragón y
//   Extremadura). Preferimos es.wikipedia si el artículo existe en español.
...
const es = (articulo) => ({ lang: 'es', articulo })
const en = (articulo) => ({ lang: 'en', articulo })

export const ELECCIONES = [
  {
    id: 'generales', tipo: 'generales', nombre: 'Elecciones generales de España',
    camara: { nombre: 'Congreso de los Diputados', escanos: 350, mayoria: 176 },
    ultimaFecha: '2023-07-23', proxima: { valor: null, confirmada: false },
  ...
  {
    id: 'europeas', tipo: 'europeas', nombre: 'Elecciones al Parlamento Europeo (España)',
    camara: { nombre: 'Parlamento Europeo (delegación española)', escanos: 61, mayoria: 31 },
    ultimaFecha: '2024-06-09', proxima: { valor: null, confirmada: false },
    wikiSondeos: null,
    wikiResultados: es('Elecciones al Parlamento Europeo de 2024 (España)'),
  },
  {
    id: 'andalucia', tipo: 'autonomica', nombre: 'Elecciones al Parlamento de Andalucía', comunidad: 'Andalucía',
    camara: { nombre: 'Parlamento de Andalucía', escanos: 109, mayoria: 55 },
    ultimaFecha: '2026-05-17', proxima: { valor: '2030-06-16', confirmada: false },
    wikiSondeos: en('Next Andalusian regional election'),
    wikiResultados: es('Elecciones al Parlamento de Andalucía de 2026'),
  },
  {
    id: 'cataluna', tipo: 'autonomica', nombre: 'Elecciones al Parlamento de Cataluña', comunidad: 'Cataluña',
    camara: { nombre: 'Parlamento de Cataluña', escanos: 135, mayoria: 68 },
    ultimaFecha: '2024-05-12', proxima: { valor: '2028-06-26', confirmada: false },
  ...
  {
    id: 'madrid', tipo: 'autonomica', nombre: 'Elecciones a la Asamblea de Madrid', comunidad: 'Comunidad de Madrid',
    camara: { nombre: 'Asamblea de Madrid', escanos: 143, mayoria: 72 },
    ultimaFecha: '2023-05-28', proxima: { valor: '2027-05-23', confirmada: false },
    wikiSondeos: en('2027 Madrilenian regional election'),
    wikiResultados: es('Elecciones a la Asamblea de Madrid de 2023'),
  },
  {
    id: 'comunidad-valenciana', tipo: 'autonomica', nombre: 'Elecciones a las Cortes Valencianas', comunidad: 'Comunidad Valenciana',
  ...
  {
    id: 'galicia', tipo: 'autonomica', nombre: 'Elecciones al Parlamento de Galicia', comunidad: 'Galicia',
    camara: { nombre: 'Parlamento de Galicia', escanos: 75, mayoria: 38 },
    ultimaFecha: '2024-02-18', proxima: { valor: '2028-03-25', confirmada: false },
  ...
  {
    id: 'pais-vasco', tipo: 'autonomica', nombre: 'Elecciones al Parlamento Vasco', comunidad: 'País Vasco',
    camara: { nombre: 'Parlamento Vasco', escanos: 75, mayoria: 38 },
    ultimaFecha: '2024-04-21', proxima: { valor: '2028-05-21', confirmada: false },
    wikiSondeos: en('Next Basque regional election'),
    wikiResultados: es('Elecciones al Parlamento Vasco de 2024'),
  },
  {
    id: 'castilla-la-mancha', tipo: 'autonomica', nombre: 'Elecciones a las Cortes de Castilla-La Mancha', comunidad: 'Castilla-La Mancha',
  ...
  {
    id: 'aragon', tipo: 'autonomica', nombre: 'Elecciones a las Cortes de Aragón', comunidad: 'Aragón',
    camara: { nombre: 'Cortes de Aragón', escanos: 67, mayoria: 34 },
    ultimaFecha: '2026-02-08', proxima: { valor: null, confirmada: false },
    wikiSondeos: null,
    wikiResultados: es('Elecciones a las Cortes de Aragón de 2026'),
  },
  {
    id: 'canarias', tipo: 'autonomica', nombre: 'Elecciones al Parlamento de Canarias', comunidad: 'Canarias',
  ...
  {
    id: 'illes-balears', tipo: 'autonomica', nombre: 'Elecciones al Parlamento de las Islas Baleares', comunidad: 'Islas Baleares',
  ...
  {
    id: 'murcia', tipo: 'autonomica', nombre: 'Elecciones a la Asamblea Regional de Murcia', comunidad: 'Región de Murcia',
  ...
  {
    id: 'extremadura', tipo: 'autonomica', nombre: 'Elecciones a la Asamblea de Extremadura', comunidad: 'Extremadura',
    camara: { nombre: 'Asamblea de Extremadura', escanos: 65, mayoria: 33 },
    ultimaFecha: '2025-12-21', proxima: { valor: null, confirmada: false },
    wikiSondeos: null,
    wikiResultados: es('Elecciones a la Asamblea de Extremadura de 2025'),
  },
  {
    id: 'asturias', tipo: 'autonomica', nombre: 'Elecciones a la Junta General del Principado de Asturias', comunidad: 'Asturias',
  ...
  {
    id: 'navarra', tipo: 'autonomica', nombre: 'Elecciones al Parlamento de Navarra', comunidad: 'Navarra',
  ...
  {
    id: 'cantabria', tipo: 'autonomica', nombre: 'Elecciones al Parlamento de Cantabria', comunidad: 'Cantabria',
  ...
  {
    id: 'la-rioja', tipo: 'autonomica', nombre: 'Elecciones al Parlamento de La Rioja', comunidad: 'La Rioja',
  ...
  {
    id: 'ceuta', tipo: 'autonomica', nombre: 'Elecciones a la Asamblea de Ceuta', comunidad: 'Ceuta', ciudadAutonoma: true,
  ...
  {
    id: 'melilla', tipo: 'autonomica', nombre: 'Elecciones a la Asamblea de Melilla', comunidad: 'Melilla', ciudadAutonoma: true,
...
export function eleccionPorId(id) {
  return ELECCIONES.find((e) => e.id === id)
}

const COLORES = {
  PP: '#1d6fb8', PSOE: '#e30613', PSC: '#e30613', PSDEG: '#e30613', PSPV: '#e30613', PSE: '#e30613', PSOEA: '#e30613',
  VOX: '#5ac035', SUMAR: '#e5007d', PODEMOS: '#692c63', UP: '#692c63', UNIDASPODEMOS: '#692c63',
