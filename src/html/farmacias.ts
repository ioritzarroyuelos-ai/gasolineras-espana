...
//
// Guardias (Fases 2-14 — cobertura nacional):
//   - 44 ficheros /data/guardias-<territorio>.json cargados en paralelo
...
<body>
  ...
  (function(){
    ...
    var state = {
      ...
      cluster: null,
      userMarker: null,
      // Guardias agregadas de los 44 territorios (cobertura nacional). Cada
