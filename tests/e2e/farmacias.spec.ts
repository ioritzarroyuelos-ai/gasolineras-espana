...
// guardias (Madrid, Bizkaia, Gipuzkoa, Araba, A Coruña).
//
// Comprobamos:
...
//   - los 5 snapshots de guardias estan servidos y con count > 0
...
test.describe('Farmacias (/farmacias/)', () => {
  ...
  test('los 5 snapshots de guardias se sirven con count > 0', async ({ request }) => {
    const territorios = ['madrid', 'bizkaia', 'gipuzkoa', 'alava', 'coruna']
